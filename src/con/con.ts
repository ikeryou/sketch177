...
export class Con extends Canvas {
  ...
  private _resetParam(): void {
    ...
    Param.instance.line = Util.instance.randomInt(5, 15)
  ...
  private _eRotate(): void {
    if(this._isSndLoaded) {
      ...
      const a = this._playCnt % 16 == 0 ? Snd.SOUNDS.NOTIFICATION : Snd.SOUNDS.DISABLED
      const b = this._playCnt % 2 == 0 ? Snd.SOUNDS.TOGGLE_OFF : Snd.SOUNDS.TOGGLE_ON
      this._snd.play(this._playCnt % 4 == 0 ? a : b)
    }
  }
